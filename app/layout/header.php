...
<head>
    ...
    <meta name="description" content="Pachuco Restaurante: cocina mexicana contemporanea, reservas y pedidos en linea.">
    <title><?= e(APP_NAME) ?></title>
    <link rel="stylesheet" href="<?= e(app_url('assets/css/styles.css')) ?>">
</head>
<body>
<header class="site-header">
    <a class="brand" href="<?= e(app_url('index.php')) ?>">Pachuco</a>
    <nav class="main-nav" aria-label="Navegacion principal">
        <a href="<?= e(app_url('index.php')) ?>">Inicio</a>
        <a href="<?= e(app_url('menu.php')) ?>">Menu</a>
